...
/**
 * Servlet implementation class Soccertp
 */
@WebServlet("/soccertp.pg")
public class Soccertp extends HttpServlet {
...
//				110 10 = 11 	  =  11 - 0 <- 						11.0   11.0
		...
		ArrayList<Product> list = new SoccerService().SoccertpProduct(pi);
