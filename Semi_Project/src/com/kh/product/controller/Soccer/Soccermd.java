...
/**
 * Servlet implementation class Soccermd
 */
@WebServlet("/soccermd.pg")
public class Soccermd extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		// --------------------페이징 처리------------------------
				...
				listCount = new SoccerService().SoccermdCount(); 
...
//				110 10 = 11 	  =  11 - 0 <- 						11.0   11.0
		...
		ArrayList<Product> list = new SoccerService().SoccermdProduct(pi);
